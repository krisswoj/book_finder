...
//
//        GoogleBooksResponse googleBooksResponse = googleBooksApi.findBook();
...
//
//        AllegroResponseToken allegroResponseToken = gson.fromJson(allegroApi2, AllegroResponseToken.class);
...
//        GoogleBooksResponse googleBooksResponse = googleBooksApi.findBook("przemineło z wiatrem");
//        googleBooksResponse.getItems();
    ...
    public void alleroTest() throws IOException, URISyntaxException {
        ...
        AllegroApiResponeAuction allegroApiResponeAuction = allegroServices.allegroAuctionRespone("1680", "java");
